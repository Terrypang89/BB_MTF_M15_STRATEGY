...
```
Scenario: Extended H4 whipsaw (Scenario H4 sub-state)
...
| Scenario H (direction pivot) | H4 BBUpDn over 3+ bars, TRADEINFO | H4 BBUpDn sustains 1 or 4, all TRADEINFO = -1 before |
